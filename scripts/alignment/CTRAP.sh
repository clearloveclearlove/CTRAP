...
CUDA_VISIBLE_DEVICES=${device} python train.py \
	...
	--bf16 True \
	--output_dir ckpt/${path_after_slash}_ctrap_${lamb}_${alpha} \
...
CUDA_VISIBLE_DEVICES=${device} python pred.py \
	...
	--output_path ../../data/poison/${path_after_slash}_ctrap_${lamb}_${alpha}

CUDA_VISIBLE_DEVICES=${device} python eval_sentiment.py \
	--input_path ../../data/poison/${path_after_slash}_ctrap_${lamb}_${alpha}
