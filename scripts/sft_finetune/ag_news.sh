...
CUDA_VISIBLE_DEVICES=${device} python train.py \
	...
	--bf16 True \
	--output_dir ckpt/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num} \
	--num_train_epochs 20 \
...
#	--lora_folder ../../ckpt/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}\
#	--model_folder ${model_path} \
#	--output_path ../../data/poison/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}
#
#
#CUDA_VISIBLE_DEVICES=${device} python eval_sentiment.py \
#	--input_path ../../data/poison/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}
...
CUDA_VISIBLE_DEVICES=${device} python pred_eval.py   \
	--lora_folder ../ckpt/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num} \
	--model_folder ${model_path} \
	--output_path ../data/agnews/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}